...
namespace Study_dashboard_API.Migrations
{
    ...
    [Migration("20250305214651_SubjectAndEvents")]
    partial class SubjectAndEvents
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Study_dashboard_API.Models.Event", b =>
                {
                    ...
                    b.HasOne("Study_dashboard_API.Models.Subject", null)
                        .WithMany("Events")
                    ...
                    b.HasOne("Study_dashboard_API.Models.User", null)
                        .WithMany("Events")
